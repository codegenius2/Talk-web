...
const Recorder = () => {
    ...
    return <div onClick={handleClick}
                ...
                className="rounded-lg gap-2 w-full select-none">
        <div className={joinClassNames("flex gap-3 justify-center items-center", isRecording ? "hidden" : "")}>
            ...
            <div className="prose text-lg text-neutral-600">
                Hold <kbd className="rounded-md text-neutral-700 bg-white opacity-70 border border-dotted
                 px-1.5 py-0.5">Spacebar</kbd> to speak
            </div>
        </div>
        <div className={joinClassNames("flex justify-evenly items-center", isRecording ? "" : "hidden")}>
            <div className="text-neutral-500 text-sm bg-white rounded-full px-2">
            ...
            <div className="flex justify-center items-center">
                ...
                <p className="prose text-4xl text-rose-500 rounded-lg px-2">
