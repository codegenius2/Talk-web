...
const Recorder = () => {
    ...
    return <div onClick={handleClick}
        ...
        <div className={joinClassNames("flex gap-3 justify-center items-center", isRecording ? "hidden" : "")}>
            ...
            <div className="prose text-equal-600">
                Hold <kbd className="border rounded-md text-lg text-equal-600 bg-white px-1.5 py-0.5">spacebar</kbd> to speak
            </div>
        </div>
        <div className={joinClassNames("flex justify-evenly items-center", isRecording ? "" : "hidden")}>
            ...
            <div className="flex justify-center items-center">
                ...
                <p className="prose text-2xl  text-red-400 rounded-lg px-2">
